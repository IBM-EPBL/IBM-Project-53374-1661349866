...
# 
# In this project,  I will perform an exploratory analysis on data provided by team PNT2022TMID48013, a bike-share system provider for many major cities in the United States. I will compare the system usage between three large cities: New York City, Chicago, and Washington, DC. I will also see if there are any differences within each system for those users that are registered, regular users and those users that are short-term, casual users.
...
# 
# Now it's time to collect and explore our data. In this project, I will focus on the record of individual trips taken in 2018 from our selected cities: New York City, Chicago, and Washington, DC. Each of these cities has a page where we can freely download the trip data.:
# 
...
data_files = ['./data/NYC-CitiBike-2018.csv',
              './data/Chicago-Divvy-2018.csv',
              './data/Washington-CapitalBikeshare-2018.csv',]
...
city_info = {'Washington': {'in_file': './data/Washington-CapitalBikeshare-2018.csv',
                            'out_file': './data/Washington-2018-Summary.csv'},
             'Chicago': {'in_file': './data/Chicago-Divvy-2018.csv',
                         'out_file': './data/Chicago-2018-Summary.csv'},
             'NYC': {'in_file': './data/NYC-CitiBike-2018.csv',
                     'out_file': './data/NYC-2018-Summary.csv'}}
...
data_file1 = './data/Washington-2018-Summary.csv'
data_file2 = './data/NYC-2018-Summary.csv'
data_file3 = './data/Chicago-2018-Summary.csv'
...
data_file = './data/Washington-2018-Summary.csv'
